...
$qrys1="select id from  update_food_snacks ORDER BY id ASC";
...
$rdate=date("D-M-Y");
 ...
 $qrys1="insert into  update_food_snacks values( $id,'$type','$food_name','$quantity','$amount','$image','0','$rdate')";
  if ($conn->query($qrys1) === TRUE) {
  move_uploaded_file($tmp_name,"Upload/".$image);
  ?>					
	<script language="javascript">
	alert("Update Snacks And Foods Success");
	window.location.href="canteen_update_snacks_food.php";
	</script>
	<?php
 }
 else
...
<body>
 ...
 <form name="form1" method="post" action="" enctype="multipart/form-data">
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <h1 align="center">Update Snacks & Food</h1>
            <p align="center">&nbsp; </p>
            ...
            <table width="421" height="351" border="0" align="center">
              ...
              <tr>
                <td>Quantity</td>
                <td><label>
                  <input name="quantity" type="text" id="quantity" required>
                </label></td>
              </tr>
              <tr>
                <td>Amount</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><label>
                  <input name="btn" type="submit" id="btn" value="Update" onClick="return customer_register()">
                </label></td>
              </tr>
            </table>
            <p>&nbsp;</p>
